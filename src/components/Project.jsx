          ...
          return (
            ...
            >
              <motion.img
                ...
                src={project.image}
                alt={project.name}
                className="w-full h-full group object-cover  md:object-contain  transition-transform duration-500 group-hover:scale-110"
              />
              <motion.div
                initial={{ opacity: 0 }}
              ...
              > 
                ...
                <p className="mb-5 p-4 text-sm md:text-lg">{project.description}</p>
                <a
